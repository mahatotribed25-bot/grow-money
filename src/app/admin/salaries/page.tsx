...
import { IndianRupee, Timer, CreditCard, Send, PlusCircle, History, Landmark, Coins, TrendingUp } from 'lucide-react';
                                    ...
                                    <TableRow key={log.id} className="border-white/[0.03] hover:bg-white/[0.01]">
                                        ...
                                        <TableCell>
                                            <div className="flex flex-col">
                                                <span className="text-sm font-black text-green-400">₹{log.netPaid.toLocaleString()}</span>
            ...
            <Dialog open={isPayDialogOpen} onOpenChange={setIsPayDialogOpen}>
                <DialogContent className="bg-[#030408]/90 backdrop-blur-2xl border-white/10 text-white rounded-[2rem] max-w-lg">
                    ...
                    <div className="grid grid-cols-2 gap-4 py-6">
                        ...
                        <div className="space-y-2">
                            <Label className="text-[10px] font-black uppercase tracking-widest text-white/40 ml-1">Base Salary (INR)</Label>
